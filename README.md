...
# Load the dataset
df_data = pd.read_csv('/content/tesla-stock-historical-data.csv')
...
plt.title("Autocorrelation Function (ACF) of Volume from tesla.csv")
plt.xlabel("Lag")
...
```
### OUTPUT:
<img width="1155" height="604" alt="image" src="https://github.com/user-attachments/assets/3194678c-d8a8-408f-b62c-409619784888" />
